...
Lab 5 returns to the `dig1.csv` data file we used in Labs 1 and 2. The data remain available on the [500-data web page](https://github.com/THOMASELOVE/500-data) Refer to [Lab 1](lab1.qmd) for more details on the data set and supplementary files about the DIG study.
