...
1. Download and install **the latest version of R** (version **4.2.2 or later**) from <https://cran.case.edu/> or, if you prefer, from <https://cloud.r-project.org/>, which automatically chooses a fast, nearby mirror for you.
    - If you have a pre-existing installation of R and/or RStudio, we highly recommend that you re-install both to get current.

2. Download and install **RStudio Desktop** (Open Source Edition - the free version **2022.12.0+353 or later**) by visiting <https://posit.co/download/rstudio-desktop/#download>. This will also load everything you need for Quarto.
