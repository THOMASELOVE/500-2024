...
1. Submit your pre-presentation version of your Abstract, and of your Slides in time for your presentation to our **Shared Google Drive**. (This deadline depends on when you are actually giving your presentation.)
...
After all of the project proposals have been approved, we will settle on a schedule for the presentations and post that schedule on the date specified in the [Course Calendar](calendar.qmd). Your slides must be submitted to the appropriate place in our **Shared Google Drive** in either PDF, HTML (slides), Google Slides or Powerpoint format, along with your pre-presentation Abstract, according to the deadline in the [Course Calendar](calendar.qmd) associated with your project presentation date.
