...
1. The [Project Proposal](#the-project-proposal) for which you will submit to [Canvas](https://canvas.case.edu/) an initial draft for my review, and then a second draft responding to my review and providing more details, according to the deadlines in the [Course Calendar](calendar.qmd). With the second draft, you will also need to complete [this scheduling form](https://bit.ly/500-project-schedule-2024).

- Once you have your data, you will probably want to look at the [Analysis Tips](#analysis-tips) we've gathered.

2. The [Project Update](#the-project-update) is the next step, also submitted to [Canvas](https://canvas.case.edu/). Here you will be revising your proposal, verifying that you have the data and are proceeding appropriately. 
...
- As part of the second draft, you will also [complete this form](https://bit.ly/500-project-schedule-2024) related to scheduling the presentations. The form will open on 
...
2. Give your presentation in class, according to the [schedule posted here](https://github.com/THOMASELOVE/500-classes-2024/blob/main/project/schedule.md) that we developed during the semester, and is linked on the [Course Calendar](calendar.qmd).
...
After all of the project proposals have been approved, we have settled on a schedule for the presentations [posted here](https://github.com/THOMASELOVE/500-classes-2024/blob/main/project/schedule.md) and specified in the [Course Calendar](calendar.qmd). Your slides must be submitted to the appropriate place in our **Shared Google Drive** in either PDF, HTML (slides), Google Slides or Powerpoint format, along with your pre-presentation Abstract, according to the deadline in the [Course Calendar](calendar.qmd) and [Project Schedule page](https://github.com/THOMASELOVE/500-classes-2024/blob/main/project/schedule.md) associated with your project presentation date.
