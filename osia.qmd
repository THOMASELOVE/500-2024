...
1. You will be responsible for presenting the methods and results of an observational study from the literature that uses propensity score methods. 
    - Approximately 10 of the presentations will be done "live" and the rest will be submitted as a recording.
    
2. You will also serve as "second reviewer" from one of the studies selected by your colleagues. 
    - Again, about ten of you will do this "live" and the rest will record your second reviewer comments.
...
You will give a 12-15 minute presentation to the rest of the class summarizing the background, methods and key results of the study. 
...
For each OSIA study, everyone will read the abstracts in advance, so that we can have some understanding of what's involved and contribute to the discussion. The papers will be posted to [the Claims page](https://github.com/THOMASELOVE/500-osia-2024/blob/main/claims.md) as they are approved by Dr. Love, and the Shared Google Drive will eventually contain all of the presentations.

## Presentation Submission Details (for Recorded Talks)

### for the Primary Reviewer

For the study you have claimed, you will submit a recording (not to exceed 12 minutes) of your presentation by the deadline Dr. Love will provide. You will also include your slides in your submission. The file name for each should include your name.

- This will allow Dr. Love, the second reviewer of your article, and anyone else in the class to review your slides in advance.

### for the Second Reviewer

You will submit a recording (not to exceed 4 minutes) of your presentation by the deadline Dr. Love will provide. You will also include your 2-4 slides in your submission. The file name for each should include your name. 

We expect you to have reviewed the slides prepared by the principal reviewer (which will be posted the day before) in preparing your materials.
